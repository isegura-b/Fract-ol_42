...
/*   Updated: 2025/01/28 14:12:16 by isegura-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void    handle_pixel(int x, int y, t_fractal *fractal)
{
    ...
    while(i < fractal->iterations_defintion)//iterations
    {
		...
		else if((z.x * z.x) + (z.y * z.y) > fractal->escape_value && (i % 5) == 2)
        {
     		my_pixel_put(x, y, &fractal->img, BLUE3);
        }
		else if((z.x * z.x) + (z.y * z.y) > fractal->escape_value && (i % 5) == 3)
      {
     		my_pixel_put(x, y, &fractal->img, BLUE4);
        }
		else if((z.x * z.x) + (z.y * z.y) > fractal->escape_value && (i % 5) == 4)
        {
     		my_pixel_put(x, y, &fractal->img, BLUE5);
        }
		else if((z.x * z.x) + (z.y * z.y) > fractal->escape_value && (i % 5) == 0)
        {
